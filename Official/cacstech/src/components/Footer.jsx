        ...
        <section className=''>
          <MDBRow style={{display : "flex" , justifyContent : "space-evenly"}}>
             <MDBCol lg='3' md='6' className='mb-4 mb-md-0'>
                ...
                <li>
                <a style={{textDecoration : "none"}} href="https://maps.app.goo.gl/DQA68EG8MkB33AMd9" class="text-white" target="_blank" rel="noopener noreferrer">IIIT Kota, Kota, 325003</a>
                </li>
              </ul>
            </MDBCol>
